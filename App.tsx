        ...
        <div className="flex justify-between h-16">
          ...
          <div className="md:hidden flex items-center">
            <button
              ...
              className="text-slate-600 p-2 focus-visible:ring-2 focus-visible:ring-blue-500 rounded-lg outline-none active:scale-95 transition-all"
...
export default function App() {
  return (
    <Router>
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 z-[100] bg-emerald-600 text-white px-4 py-2 rounded-lg font-bold shadow-lg"
      >
