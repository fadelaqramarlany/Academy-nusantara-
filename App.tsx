        ...
        <div>
          ...
          <div className="flex space-x-4">
            <a
              ...
              className="bg-white/5 border border-white/10 p-3 rounded-2xl hover:bg-emerald-600 hover:text-white active:scale-95 transition-all outline-none focus-visible:ring-2 focus-visible:ring-emerald-500"
            >
              <Phone size={20} />
            </a>
          </div>
...
export default function App() {
  return (
    <Router>
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 bg-emerald-600 text-white px-4 py-2 rounded-lg font-bold z-[100] outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500"
      >
