      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <a href="https://wa.me/628827793100" aria-label="WhatsApp" className="bg-white/5 border border-white/10 p-3 rounded-2xl hover:bg-emerald-600 hover:text-white active:scale-95 transition-all">
              <Phone size={20} />
            </a>
          </div>
        </div>
