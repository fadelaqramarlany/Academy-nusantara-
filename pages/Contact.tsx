              ...
              {!isSubmitted ? (
                ...
                >
                  ...
                  <p className="text-slate-600 mb-10 leading-relaxed font-medium">
                    Terima kasih telah menghubungi Academy Nusantara. Admin akan meninjau pesan Anda dan menghubungi Anda sesegera mungkin.
                  </p>
                  <button
                    onClick={() => setIsSubmitted(false)}
                    className="bg-slate-900 text-white px-8 py-4 rounded-2xl font-bold hover:bg-blue-600 transition-all active:scale-95 shadow-lg"
                  >
                    Kirim Pesan Lagi
                  </button>
                </motion.div>
