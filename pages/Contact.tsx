            ...
            <AnimatePresence mode="wait">
              {!isSubmitted ? (
                ...
                >
                  ...
                  <h3 className="text-2xl font-black text-slate-900 mb-4 uppercase tracking-tight">Terima Kasih!</h3>
                  <p className="text-slate-600 font-medium leading-relaxed mb-8">
                    Pesan Anda telah berhasil terkirim. Admin Academy Nusantara akan menghubungi Anda segera melalui kontak yang tersedia.
                  </p>
                  <button
                    onClick={() => setIsSubmitted(false)}
                    className="text-blue-600 font-bold hover:underline uppercase text-sm tracking-widest"
                  >
                    Kirim Pesan Lainnya
                  </button>
                </MotionDiv>
