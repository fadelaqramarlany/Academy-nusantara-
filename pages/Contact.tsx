            ...
            <AnimatePresence mode="wait">
              {!isSubmitted ? (
                ...
                >
                  ...
                  <h2 className="text-3xl font-black text-slate-900 mb-4 uppercase tracking-tight">Terima Kasih!</h2>
                  <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                    Pesan Anda telah kami terima. Tim Admin Academy Nusantara akan menghubungi Anda melalui email atau WhatsApp dalam waktu 1x24 jam.
                  </p>
                  <button
                    onClick={() => setIsSubmitted(false)}
                    className="text-blue-600 font-bold hover:underline uppercase tracking-widest text-sm"
                  >
                    Kirim pesan lain
                  </button>
                </motion.div>
