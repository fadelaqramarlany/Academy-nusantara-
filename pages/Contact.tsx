          ...
          <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-xl border border-slate-200 min-h-[500px] flex flex-col">
            ...
            {!isSubmitted ? (
              ...
              <div className="flex-grow flex flex-col items-center justify-center text-center space-y-4">
                <div className="bg-emerald-100 p-6 rounded-full text-emerald-600 mb-4 animate-in zoom-in duration-300">
                  <CheckCircle2 size={64} />
                </div>
                <h3 className="text-2xl font-black text-slate-900 uppercase">Pesan Terkirim!</h3>
                <p className="text-slate-600 font-medium">Admin Academy Nusantara akan menghubungi Anda segera.</p>
                <button
                  onClick={() => setIsSubmitted(false)}
                  className="mt-8 text-blue-600 font-bold uppercase tracking-widest text-sm hover:underline"
                >
                  Kirim Pesan Lagi
                </button>
              </div>
