            ...
            <AnimatePresence mode="wait">
              {!isSubmitted ? (
                ...
                >
                  ...
                  <p className="text-slate-600 font-bold mb-10 leading-relaxed max-w-xs mx-auto">
                    Terima kasih telah menghubungi kami. Admin akan segera membalas pesan Anda melalui email atau WhatsApp.
                  </p>
                  <button
                    onClick={() => setIsSubmitted(false)}
                    className="bg-slate-900 text-white px-8 py-4 rounded-2xl font-black uppercase tracking-widest text-sm hover:bg-blue-600 transition-all active:scale-95 shadow-xl"
                  >
                    Kirim Pesan Lagi
                  </button>
                </motion.div>
