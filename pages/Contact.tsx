        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-xl border border-slate-200">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button 
                type="submit"
                className="w-full bg-blue-600 text-white py-5 rounded-2xl font-bold text-lg shadow-xl hover:bg-blue-700 transition-all flex items-center justify-center gap-2 active:scale-95 transition-transform"
              >
