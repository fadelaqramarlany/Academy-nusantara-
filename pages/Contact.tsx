              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-2xl font-bold text-slate-900 hover:text-emerald-600 transition inline-block active:scale-95"
                  >
                    0882 7793 100
                  </a>
                </div>
            ...
            {isSubmitted ? (
              ...
              >
                ...
                <p className="text-slate-500 font-bold max-w-xs">
                  Admin Academy Nusantara akan segera menghubungi Anda melalui WhatsApp atau Email.
                </p>
                <button
