          ...
          <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-xl border border-slate-200">
            {!isSubmitted ? (
              ...
              <div className="text-center py-12 animate-in fade-in zoom-in duration-300">
                ...
                <p className="text-slate-600 font-medium mb-8">Admin akan menghubungi Anda segera.</p>
                <button onClick={() => setIsSubmitted(false)} className="bg-slate-900 text-white px-8 py-4 rounded-2xl font-bold active:scale-95 transition-all uppercase tracking-widest text-sm shadow-lg">Kirim Pesan Lagi</button>
              </div>
            )}
