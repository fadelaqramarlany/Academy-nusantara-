          ...
          <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-xl border border-slate-200 min-h-[500px] flex flex-col justify-center">
            {!isSubmitted ? (
              <>
                ...
                <p className="text-center text-slate-400 text-sm mt-8 italic">"Hubungi admin untuk pendaftaran festival dan kerja sama sekolah"</p>
              </>
            ) : (
              <div className="text-center py-10" role="status" aria-live="polite">
                ...
                <p className="text-slate-600 mb-10 leading-relaxed font-medium">Terima kasih telah menghubungi kami. Admin Academy Nusantara akan segera merespons pesan Anda.</p>
                <button onClick={() => setIsSubmitted(false)} className="text-blue-600 font-bold uppercase tracking-widest text-sm hover:text-blue-700 transition-colors">Kirim Pesan Lainnya</button>
              </div>
            )}
          </div>
        </div>
