          ...
          <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-xl border border-slate-200">
            {isSubmitted ? (
              <div className="py-12 text-center">
                <h2 className="text-3xl font-black text-slate-900 mb-2 uppercase tracking-tighter">PESAN TERKIRIM!</h2>
                <p className="text-slate-500 font-bold mb-8">Admin akan menghubungi Anda segera.</p>
                <button onClick={() => setIsSubmitted(false)} className="px-8 py-4 bg-slate-900 text-white rounded-2xl font-bold hover:bg-blue-600 active:scale-95 transition-all shadow-lg">Kirim Pesan Lagi</button>
              </div>
            ) : (
