            ...
            <AnimatePresence mode="wait">
              {!submitted ? (
                ...
                >
                  ...
                  <h3 className="text-2xl font-black text-slate-900 mb-4 uppercase tracking-tight">PESAN TERKIRIM!</h3>
                  <p className="text-slate-500 font-medium mb-8">
                    Terima kasih telah menghubungi kami. Admin akan segera meninjau pesan Anda dan memberikan tanggapan melalui saluran yang tersedia.
                  </p>
                  <button
                    onClick={() => setSubmitted(false)}
                    className="text-blue-600 font-bold uppercase tracking-widest text-sm hover:underline active:scale-95 transition-all"
                  >
                    Kirim Pesan Lagi
                  </button>
                </MotionDiv>
