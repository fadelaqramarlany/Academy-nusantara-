...
import { Trophy, BookOpen, GraduationCap, ChevronRight, Award, Zap, Brain, UserPlus, ShieldCheck, CheckCircle2 } from 'lucide-react';
              ...
              <AnimatePresence mode="wait">
                {!isSubmitted ? (
                  ...
                  >
                    ...
                    <p className="text-slate-500 font-bold uppercase tracking-widest text-sm mb-12">Data Anda telah aman di Database Nasional</p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                      <a href="#jenjang" className="bg-emerald-600 text-white px-10 py-5 rounded-2xl font-black shadow-2xl hover:bg-emerald-700 transition-all uppercase tracking-widest active:scale-95">Mulai Kuis</a>
                      <button onClick={() => setIsSubmitted(false)} className="bg-slate-100 text-slate-600 px-10 py-5 rounded-2xl font-black hover:bg-slate-200 transition-all uppercase tracking-widest active:scale-95">Daftar Lagi</button>
                    </div>
                  </MotionDiv>
                )}
              </AnimatePresence>
