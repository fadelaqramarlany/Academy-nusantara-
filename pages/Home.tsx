           ...
           <div className="bg-white p-12 rounded-[3rem] shadow-2xl border-t-8 border-blue-600">
              ...
              >
                ...
                >
                  ...
                  <p className="text-slate-500 font-bold mb-8">Data Anda telah masuk ke Database Prestasi Nasional.</p>
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <a
                      href="#jenjang"
                      className="bg-blue-600 text-white px-8 py-4 rounded-2xl font-black uppercase tracking-widest hover:bg-blue-700 transition-all active:scale-95 shadow-lg"
                    >
                      Mulai Kuis
                    </a>
                    <button
