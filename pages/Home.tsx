           ...
           <div className="bg-white p-12 rounded-[3rem] shadow-2xl border-t-8 border-blue-600">
              {isSubmitted ? (
                ...
                >
                  ...
                  <p className="text-slate-500 font-bold uppercase tracking-wide mb-10 max-w-md mx-auto">Data Anda telah masuk ke Database Prestasi Nasional. Silakan mulai kuis pertama Anda.</p>
                  <button
                ...
                <>
                  ...
                  <form className="grid md:grid-cols-2 gap-6" onSubmit={handleSubmit}>
                    {[
                      { id: 'student-name', label: 'Nama Lengkap', placeholder: 'Nama sesuai rapor...', type: 'text' },
                      { id: 'student-nisn', label: 'NISN', placeholder: 'Nomor Induk Siswa...', type: 'text' },
                      { id: 'school-name', label: 'Asal Sekolah', placeholder: 'Nama sekolah lengkap...', type: 'text' }
                    ].map((field) => (
                      <div key={field.id} className="space-y-4">
                        ...
                        <input id={field.id} type={field.type} placeholder={field.placeholder} required className="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:border-blue-500 outline-none font-bold transition-all" />
                      </div>
                    ))}
