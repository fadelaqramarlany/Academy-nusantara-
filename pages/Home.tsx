              ...
              {!isSubmitted ? (
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="#jenjang" className="bg-blue-600 text-white px-8 py-4 rounded-2xl font-black uppercase tracking-widest hover:bg-blue-700 transition-all active:scale-95">Mulai Kuis</a>
