      ...
      <section id="pendaftaran" className="py-24 bg-slate-50 border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-6">
           <div className="bg-white p-12 rounded-[3rem] shadow-2xl border-t-8 border-blue-600">
              ...
              {isSubmitted ? (
                <div className="bg-emerald-50 border-2 border-emerald-500/20 p-10 rounded-[2rem] text-center space-y-4">
                  <div className="inline-flex items-center justify-center w-20 h-20 bg-emerald-500 text-white rounded-3xl shadow-lg mb-4">
                  ...
                  <p className="text-slate-600 font-bold max-w-sm mx-auto uppercase text-sm tracking-wide">
