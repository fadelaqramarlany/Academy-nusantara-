    ...
    <div className="overflow-hidden">
      ...
      <section id="pendaftaran" className="py-24 bg-slate-50 border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-6">
           <div className="bg-white p-12 rounded-[3rem] shadow-2xl border-t-8 border-blue-600 overflow-hidden">
              ...
              {!isSubmitted ? (
                ...
                >
                  ...
                  <p className="text-slate-500 font-bold uppercase tracking-widest text-sm mb-10">Data Anda telah masuk ke Database Prestasi Nasional.</p>
                  <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <a href="#jenjang" className="bg-emerald-600 text-white px-8 py-4 rounded-2xl font-black uppercase tracking-widest hover:bg-emerald-700 transition-all shadow-lg active:scale-95 text-sm">
                      Mulai Kuis
                    </a>
                    <button
                      onClick={() => setIsSubmitted(false)}
                      className="text-slate-500 font-black uppercase tracking-widest hover:text-slate-900 transition-all text-xs"
                    >
                      Daftar Lagi
                    </button>
                  </div>
