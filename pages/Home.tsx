    ...
    <div className="overflow-hidden">
      ...
      <section id="pendaftaran" className="py-24 bg-slate-50 border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-6">
           <div className="bg-white p-12 rounded-[3rem] shadow-2xl border-t-8 border-blue-600 min-h-[500px] flex items-center justify-center">
              <AnimatePresence mode="wait">
                {!isSubmitted ? (
                  ...
                  >
                    ...
                    <p className="text-slate-500 font-bold uppercase tracking-widest text-sm max-w-sm mx-auto mb-10">
                      Data Anda telah tersimpan. Silakan pilih jenjang pendidikan untuk mulai kuis pertama Anda.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                      <button
                        onClick={() => setIsSubmitted(false)}
                        className="text-slate-500 font-black uppercase tracking-widest text-xs hover:text-slate-900 transition-colors"
                      >
                        Daftar Peserta Lain
                      </button>
                    </div>
