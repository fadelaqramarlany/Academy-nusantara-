        ...
        <div className="max-w-4xl mx-auto px-6">
           <div className="bg-white p-12 rounded-[3rem] shadow-2xl border-t-8 border-blue-600">
              {isSubmitted ? (
                ...
                >
                  <CheckCircle2 className="w-20 h-20 text-emerald-500 mx-auto mb-6" aria-hidden="true" />
                  <h2 className="text-4xl font-black text-slate-900 uppercase tracking-tighter mb-4">PENDAFTARAN BERHASIL!</h2>
                  <p className="text-slate-500 font-bold uppercase tracking-widest text-sm mb-10">Data Anda telah tersimpan. Selamat belajar!</p>
                  <button
                    onClick={() => setIsSubmitted(false)}
                    className="bg-slate-900 text-white px-10 py-5 rounded-2xl font-black uppercase tracking-widest hover:bg-emerald-600 transition-all shadow-xl active:scale-95"
                  >
                    Daftar Lagi
                  </button>
                </MotionDiv>
