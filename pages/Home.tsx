                ...
                {!isSubmitted ? (
                  ...
                  >
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                      <a
                        href="#jenjang"
                        className="bg-emerald-600 text-white px-10 py-5 rounded-2xl font-black shadow-2xl hover:bg-emerald-700 transition-all flex items-center justify-center gap-3 uppercase tracking-widest active:scale-95"
                      >
                        Mulai Kuis <ChevronRight size={20} />
                      </a>
                      <button
