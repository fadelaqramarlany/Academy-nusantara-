        ...
        <div className="max-w-4xl mx-auto px-6">
           <div className="bg-white p-12 rounded-[3rem] shadow-2xl border-t-8 border-blue-600">
              ...
              {!isSubmitted ? (
                ...
                >
                  <div className="bg-emerald-100 text-emerald-600 w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-8">
                  ...
                  <p className="text-slate-500 font-bold mb-10 uppercase text-xs tracking-widest leading-relaxed">
                    Data Anda telah aman di database nasional.<br/>Silakan mulai kuis pertama Anda sekarang.
                  </p>
                  <button
