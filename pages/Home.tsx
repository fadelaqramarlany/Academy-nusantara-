              ...
              {isSubmitted ? (
                <div className="text-center py-10">
                  <div className="bg-emerald-100 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6">
                    <CheckCircle2 className="text-emerald-600 w-10 h-10" aria-hidden="true" />
                  </div>
                  <h3 className="text-2xl font-black text-slate-900 uppercase tracking-tighter mb-4">PENDAFTARAN BERHASIL!</h3>
                  <p className="text-slate-500 font-bold mb-8 uppercase tracking-widest text-xs">Silakan mulai kuis pertama Anda.</p>
                  <button
                    onClick={() => setIsSubmitted(false)}
                    className="bg-slate-900 text-white px-10 py-5 rounded-2xl font-black uppercase tracking-widest hover:bg-emerald-600 transition-all active:scale-95 shadow-xl"
                  >
                    Daftar Lagi
                  </button>
                </div>
