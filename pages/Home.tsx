           ...
           <div className="bg-white p-12 rounded-[3rem] shadow-2xl border-t-8 border-blue-600">
              ...
              <form className="grid md:grid-cols-2 gap-6" onSubmit={(e) => { e.preventDefault(); setIsSubmitted(true); }}>
                ...
                <div className="text-center py-10 space-y-6">
                   ...
                   <p className="text-slate-500 font-bold uppercase tracking-widest text-xs">Silakan mulai kuis pertama Anda.</p>
                   <button
                    onClick={() => setIsSubmitted(false)}
                    className="bg-slate-900 text-white px-10 py-4 rounded-2xl font-black uppercase tracking-widest hover:bg-blue-600 transition-all active:scale-95 shadow-xl"
                   >
                    Daftar Lagi
                   </button>
                </div>
