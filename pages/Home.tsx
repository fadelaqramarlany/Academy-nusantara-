...
import { Trophy, BookOpen, GraduationCap, Award, Zap, Brain, UserPlus, CheckCircle2 } from 'lucide-react';
           ...
           <div className="bg-white p-12 rounded-[3rem] shadow-2xl border-t-8 border-blue-600 min-h-[500px] flex flex-col justify-center">
              <AnimatePresence mode="wait">
                 {!isSubmitted ? (
                    ...
                    >
                       <CheckCircle2 className="w-24 h-24 text-emerald-500 mx-auto mb-8 animate-bounce" />
                       <h2 className="text-4xl font-black text-slate-900 uppercase tracking-tighter mb-4">PENDAFTARAN BERHASIL!</h2>
                       <p className="text-slate-500 font-bold uppercase tracking-widest text-xs mb-10 max-w-sm mx-auto">Selamat! Data Anda telah terverifikasi dalam sistem Academy Nusantara.</p>
                       <div className="flex flex-col sm:flex-row gap-4 justify-center">
                          <Link to="/festival" className="bg-emerald-600 text-white px-8 py-4 rounded-2xl font-black uppercase tracking-widest hover:bg-emerald-700 transition-all active:scale-95 shadow-lg">Mulai Kuis</Link>
