              ...
              {isSubmitted ? (
                 ...
                 >
                    <div className="flex justify-center mb-6">
                       <div className="bg-emerald-100 p-6 rounded-[2.5rem]">
                    ...
                    <p className="text-slate-500 font-bold max-w-sm mx-auto leading-relaxed mb-8">
                       Data Anda telah tersimpan di sistem Academy Nusantara. Silakan mulai kuis pertama Anda.
                    </p>
                    <button
                       onClick={() => setIsSubmitted(false)}
                       className="bg-slate-900 text-white px-8 py-4 rounded-2xl font-black uppercase tracking-widest hover:bg-emerald-600 transition-all active:scale-95"
                    >
                       Daftar Lagi
                    </button>
                 </MotionDiv>
