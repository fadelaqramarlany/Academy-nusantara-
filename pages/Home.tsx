           ...
           <div className="bg-white p-12 rounded-[3rem] shadow-2xl border-t-8 border-blue-600">
              ...
              {isSubmitted ? (
                ...
                >
                  ...
                  <p className="text-slate-500 font-bold uppercase tracking-widest text-sm mb-10">Data Anda telah tersimpan. Silakan mulai kuis pertama Anda.</p>
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="#jenjang" className="bg-blue-600 text-white px-10 py-5 rounded-2xl font-black uppercase tracking-widest hover:bg-blue-700 transition-all active:scale-95 shadow-xl">
                      Mulai Kuis
                    </a>
                    <button
                      onClick={() => setIsSubmitted(false)}
                      className="bg-slate-100 text-slate-600 px-10 py-5 rounded-2xl font-black uppercase tracking-widest hover:bg-slate-200 transition-all active:scale-95"
                    >
                      Daftar Lagi
                    </button>
                  </div>
