                  ...
                  >
                    ...
                    >
                       <div className="space-y-4">
                          ...
                          <input id="name" type="text" placeholder="Nama sesuai rapor..." required className="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:border-blue-500 outline-none font-bold" />
                       </div>
                       <div className="space-y-4">
                       ...
                       <div className="space-y-4">
                          ...
                          <input id="school" type="text" placeholder="Nama sekolah lengkap..." required className="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:border-blue-500 outline-none font-bold" />
                       </div>
                       <div className="space-y-4">
                          <label htmlFor="level" className="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-2">Jenjang</label>
                          <select id="level" className="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:border-blue-500 outline-none font-bold">
                             <option>SD</option>
                             <option>SMP</option>
                             <option>SMA</option>
                          </select>
                       </div>
                       <button className="md:col-span-2 bg-slate-900 text-white py-5 rounded-2xl font-black uppercase tracking-widest hover:bg-blue-600 transition-all shadow-xl mt-4 active:scale-95 transition-transform">Simpan Data Peserta</button>
                    </form>
                  </MotionDiv>
                ) : (
                  <MotionDiv
                  ...
                  >
                    <div className="flex justify-center mb-6">
                      <MotionDiv
                        ...
                        className="w-24 h-24 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center shadow-lg"
                      >
                        <CheckCircle2 size={48} />
                      </MotionDiv>
                    </div>
                    <h2 className="text-4xl font-black text-slate-900 uppercase tracking-tighter mb-4">PENDAFTARAN BERHASIL!</h2>
                    <p className="text-slate-500 font-bold uppercase tracking-widest text-sm mb-10 max-w-md mx-auto">
                      Data Anda telah tersimpan di sistem kami. Silakan pilih jenjang pendidikan untuk memulai kuis.
                    </p>
                    <div className="flex flex-col gap-4 max-w-xs mx-auto">
                      <Link
                        to="/festival"
                        className="bg-blue-600 text-white py-4 rounded-2xl font-black uppercase tracking-widest hover:bg-blue-700 transition-all shadow-xl active:scale-95 text-center"
                      >
                        Mulai Kuis
                      </Link>
                      <button
