              ...
              <AnimatePresence mode="wait">
                {!isSubmitted ? (
                  ...
                  >
                    ...
                    <p className="text-slate-600 font-bold mb-10 max-w-md mx-auto">Data Anda telah tersimpan. Silakan pilih jenjang pendidikan untuk mulai kuis pertama Anda.</p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                      <a href="#jenjang" className="bg-emerald-600 text-white px-8 py-4 rounded-2xl font-black uppercase tracking-widest hover:bg-emerald-700 transition-all shadow-lg active:scale-95">Mulai Kuis</a>
