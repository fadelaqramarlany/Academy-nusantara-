           ...
           <div className="bg-white p-12 rounded-[3rem] shadow-2xl border-t-8 border-blue-600">
              {isRegistered ? (
                ...
                >
                  ...
                  <p className="text-slate-600 font-bold text-lg mb-8">Data Anda telah masuk ke Database Prestasi Nasional. Silakan mulai kuis pertama Anda.</p>
                  <button
                    onClick={() => setIsRegistered(false)}
                    className="bg-slate-900 text-white px-8 py-4 rounded-2xl font-black uppercase tracking-widest hover:bg-blue-600 transition-all active:scale-95 shadow-xl"
                  >
                    Daftar Lagi
                  </button>
                </MotionDiv>
                ...
                <>
                  ...
                  <form className="grid md:grid-cols-2 gap-6" onSubmit={(e) => { e.preventDefault(); setIsRegistered(true); }}>
                     ...
                     <button type="submit" className="md:col-span-2 bg-slate-900 text-white py-5 rounded-2xl font-black uppercase tracking-widest hover:bg-blue-600 transition-all active:scale-95 shadow-xl mt-4">Simpan Data Peserta</button>
                  </form>
                </>
              )}
           </div>
