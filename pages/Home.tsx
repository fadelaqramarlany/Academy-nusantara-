...
import { Trophy, BookOpen, GraduationCap, ChevronRight, Award, Zap, Brain, UserPlus, Check } from 'lucide-react';
                ...
                {!isSubmitted ? (
                  ...
                  >
                    <form className="grid md:grid-cols-2 gap-6" onSubmit={(e) => { e.preventDefault(); setIsSubmitted(true); }}>
                       ...
                       <div className="space-y-4">
                          <label htmlFor="educationLevel" className="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-2">Jenjang</label>
                          <select id="educationLevel" className="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:border-blue-500 outline-none font-bold">
                             <option>SD</option>
                             <option>SMP</option>
                             <option>SMA</option>
                          </select>
                  ...
                  >
                    ...
                    <h3 className="text-2xl font-black text-slate-900 uppercase tracking-tighter">Pendaftaran Berhasil!</h3>
                    <p className="text-slate-500 font-bold mt-2 uppercase text-sm tracking-widest">Silakan mulai kuis pertama Anda.</p>
                  </MotionDiv>
                )}
              </AnimatePresence>
           </div>
