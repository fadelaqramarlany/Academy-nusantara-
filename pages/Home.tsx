        ...
        <div className="max-w-4xl mx-auto px-6">
           <div className="bg-white p-12 rounded-[3rem] shadow-2xl border-t-8 border-blue-600">
              ...
              {isRegistered ? (
                ...
                >
                  <div className="w-24 h-24 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center mb-8 shadow-inner animate-bounce" aria-hidden="true">
                    <CheckCircle2 size={48} />
                  </div>
                  <h3 className="text-3xl font-black text-slate-900 uppercase tracking-tighter mb-4">BERHASIL TERDAFTAR!</h3>
                  <p className="text-slate-600 font-bold max-w-sm mx-auto mb-10 leading-relaxed uppercase text-xs tracking-widest">
                    Data Anda telah masuk ke Database Prestasi Nasional. Selamat berkompetisi!
                  </p>
                  <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
                    <a
                      href="#jenjang"
                      className="bg-blue-600 text-white px-8 py-4 rounded-2xl font-black uppercase tracking-widest hover:bg-blue-700 transition-all shadow-xl active:scale-95"
                    >
                      Mulai Kuis
                    </a>
                    <button
                      onClick={() => setIsRegistered(false)}
                      className="bg-slate-100 text-slate-600 px-8 py-4 rounded-2xl font-black uppercase tracking-widest hover:bg-slate-200 transition-all active:scale-95"
                    >
                      Daftar Lagi
                    </button>
                  </div>
