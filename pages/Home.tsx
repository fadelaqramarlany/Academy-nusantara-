           ...
           <div className="bg-white p-12 rounded-[3rem] shadow-2xl border-t-8 border-blue-600">
              <AnimatePresence mode="wait">
                {!isSubmitted ? (
                  ...
                  >
                    <div className="w-24 h-24 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center mx-auto mb-8 shadow-lg">
                      <CheckCircle2 size={48} />
                    </div>
                    <h2 className="text-4xl font-black text-slate-900 uppercase tracking-tighter mb-4">BERHASIL TERDAFTAR!</h2>
                    <p className="text-slate-500 font-bold uppercase tracking-widest text-sm mb-12">Data Anda telah masuk ke Database Prestasi Nasional.</p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                      <a
                        href="#jenjang"
                        className="bg-blue-600 text-white px-10 py-5 rounded-2xl font-black uppercase tracking-widest hover:bg-blue-700 transition-all shadow-xl active:scale-95 text-center"
                      >
                        Mulai Kuis
                      </a>
                      <button
                        onClick={() => setIsSubmitted(false)}
                        className="bg-slate-100 text-slate-900 px-10 py-5 rounded-2xl font-black uppercase tracking-widest hover:bg-slate-200 transition-all active:scale-95"
                      >
                        Daftar Lagi
                      </button>
                    </div>
