              ...
              <AnimatePresence mode="wait">
                {!isSubmitted ? (
                  ...
                  >
                    ...
                    <p className="text-slate-600 font-bold mb-10 max-w-sm mx-auto uppercase text-xs tracking-widest leading-relaxed">
                      Data Anda telah masuk ke Database Prestasi Nasional. Siapkan diri Anda untuk tantangan akademik.
                    </p>
                    <div className="flex flex-col gap-4 max-w-xs mx-auto">
                      <a
                        ...
                        className="bg-emerald-600 text-white py-5 rounded-2xl font-black uppercase tracking-widest hover:bg-emerald-700 transition-all shadow-xl active:scale-95"
                      >
                        Mulai Kuis
                      </a>
                      <button
                        onClick={() => setIsSubmitted(false)}
                        className="text-slate-400 font-black uppercase tracking-widest text-xs hover:text-blue-600 transition-colors py-2"
                      >
                        Daftar Lagi
                      </button>
                    </div>
