                ...
                {!isSubmitted ? (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-slate-500 font-bold uppercase tracking-widest text-sm">Data Anda telah tersimpan. Silakan mulai kuis pertama Anda.</p>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                      <a
                        href="#jenjang"
                        className="bg-blue-600 text-white px-8 py-4 rounded-2xl font-black uppercase tracking-widest hover:bg-blue-700 transition-all active:scale-95 shadow-lg shadow-blue-200"
                      >
                        Mulai Kuis
                      </a>
                      <button
