    ...
    <div className="overflow-hidden">
      ...
      <section id="pendaftaran" className="py-24 bg-slate-50 border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-6">
           <div className="bg-white p-12 rounded-[3rem] shadow-2xl border-t-8 border-blue-600 min-h-[400px] flex flex-col justify-center">
              <AnimatePresence mode="wait">
                {!isSubmitted ? (
                  ...
                  >
                    ...
                    <form className="grid md:grid-cols-2 gap-6" onSubmit={(e) => { e.preventDefault(); setIsSubmitted(true); }}>
                       ...
                       <div className="space-y-4">
                          ...
                          <select id="level" className="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:border-blue-500 outline-none font-bold cursor-pointer">
                             <option>SD</option>
                             <option>SMP</option>
                             <option>SMA</option>
                          </select>
                  ...
                  >
                    ...
                    <h2 className="text-4xl font-black text-slate-900 uppercase tracking-tighter mb-4">BERHASIL TERDAFTAR!</h2>
                    <p className="text-slate-600 font-bold mb-10 max-w-md mx-auto">
                      Data Anda telah masuk ke Database Prestasi Nasional. Silakan pilih jenjang pendidikan Anda di bawah ini untuk memulai kuis.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                      <a
                        href="#jenjang"
                        className="bg-emerald-600 text-white px-10 py-5 rounded-2xl font-black shadow-xl hover:bg-emerald-700 transition-all uppercase tracking-widest active:scale-95"
                      >
                        Mulai Kuis
                      </a>
                      <button
                        onClick={() => setIsSubmitted(false)}
                        className="bg-slate-100 text-slate-600 px-10 py-5 rounded-2xl font-black hover:bg-slate-200 transition-all uppercase tracking-widest active:scale-95"
                      >
                        Daftar Lagi
                      </button>
                    </div>
