              ...
              <AnimatePresence mode="wait">
                 {!isSubmitted ? (
                    ...
                    >
                       ...
                       <p className="text-slate-500 font-bold max-w-md mx-auto mb-10">Data Anda telah masuk ke Database Prestasi Nasional.</p>
                       <div className="flex flex-col sm:flex-row gap-4 justify-center">
                          <a
                             href="#jenjang"
                             className="bg-blue-600 text-white px-10 py-5 rounded-2xl font-black uppercase tracking-widest hover:bg-blue-700 transition-all shadow-xl active:scale-95"
                          >
                             Mulai Kuis
                          </a>
                          <button
